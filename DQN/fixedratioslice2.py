...
if __name__ == '__main__':
    ...
    _sql_communication = 'INSERT INTO "communicationdatadb_comparison2"(id, timestamp, router_sign,' \
                         ' delay, slice_sign, is_loss, task_id )' \
                         'VALUES (%s, %s, %s, %s, %s, %s, %s)'

    _sql_calculate = 'INSERT INTO "calculatedatadb_comparison2" (id, time, router_id, delay, slice_sign, task_id)  ' \
                     'VALUES (%s, %s, %s, %s, %s, %s)'

    _sql_sensor = 'INSERT INTO "sensordatadb_comparison2" (id, time, router_id, slice_id, ' \
                  'is_loss, delay, specific_type, task_id)' + 'VALUES (%s, %s, %s, %s, %s, %s, %s, %s)'
