...
try:
    ...
    writer_summary = tf2.summary.SummaryWriter
    merge_all_summaries = tf2.compat.v1.summary.merge_all
...
def get_num_actions():
    """
    Returns the _number of possible actions for the given atari game
    """
    # Figure out _number of actions from gym env
    env = gym.make(game)
