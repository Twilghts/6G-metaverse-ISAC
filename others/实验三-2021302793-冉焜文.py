...
time.sleep(3)
# 10. 选择“视频看房”
driver.find_element(by=By.XPATH, value='//*[@id="_list-content"]/div[1]/a[2]').click()
time.sleep(3)
# 11. 依次点击“租金”、“最新”排序进行查看
# 点击租金
# driver.find_element(by=By.XPATH, value='//*[@id="_list-content"]/div[2]/div/a[2]').click()
# time.sleep(1)
# # 点击最新
# driver.find_element(by=By.XPATH, value='//*[@id="_list-content"]/div[2]/div/a[3]').click()
# time.sleep(1)
# 12. 点击第一个搜索出来的房源进行查看
driver.find_element(by=By.XPATH, value='//*[@id="_list-content"]/div[3]').click()
time.sleep(3)
# 关闭
driver.close()
