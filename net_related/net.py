...
class Net:
    ...
    def initialize(self):
        for router in self.core_routers.values():
            ...
            router.distribution[1][1] = 0.65
            router.distribution[1][2] = 0.175
            router.distribution[1][3] = 0.175
        ...
        for link in self.links.values():
            ...
            link.communication_distribution[1] = 0.65
            link.communication_distribution[2] = 0.175
            link.communication_distribution[3] = 0.175
