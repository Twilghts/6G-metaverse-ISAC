...
class Net:
    ...
    def initialize(self):
        for router in self.core_routers.values():
            ...
            router.distribution[1][2] = 0.2
            router.distribution[1][3] = 0.2
        ...
        for link in self.links.values():
            ...
            link.communication_distribution[1] = 0.6
            link.communication_distribution[2] = 0.2
            link.communication_distribution[3] = 0.2
