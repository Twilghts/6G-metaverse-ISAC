...
class Net:
    ...
    def initialize(self):
        for router in self.core_routers.values():
            ...
            router.distribution[2][1] = 0.09
            router.distribution[2][2] = 0.82
            router.distribution[2][3] = 0.09
            # 针对路由器存储资源的初始化，切片三是主要处理存储业务的
            router.distribution[3][1] = 0.04
            router.distribution[3][2] = 0.04
            router.distribution[3][3] = 0.92
